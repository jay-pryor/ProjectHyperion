...
- `hyperion/core/change-control/baseline-change-procedure.md` (CORE-CHG-002)
...
- `hyperion/core/imperatives.md` (CORE-IMP-001)
...
- `hyperion/core/reviews/00-review-taxonomy.md` (CORE-REV-001)
...
- `hyperion/agents/00-agent-index.md` (AGT-000)
...
- `hyperion/templates/project-CLAUDE.md` (TPL-006)
- `hyperion/templates/module-CLAUDE.md` (TPL-007)
- `hyperion/templates/module-map.md` (TPL-008)
- `hyperion/tooling/doc-frontmatter-schema.md` (TOOL-001)
