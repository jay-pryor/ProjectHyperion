---
name: baseline
description: "BASELINE session: change shared substrate under a decision record cited in the declaration. Type it; never invoked by the model."
...
Output exactly, then stop and wait for confirmation. Do not begin work in the same turn.
    ...
    MAY MODIFY: `baseline/**`, `docs/decisions/**`, `trace/**`
