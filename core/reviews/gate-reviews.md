...
audience: [human]
load: on-task
related: [CORE-REV-001, CORE-LFC-001]
---
...
Each gate review produces a short record: date, reviewer (including "self"), findings,
disposition. Two minutes. It is what lets you calibrate later whether self-review is
catching enough.
